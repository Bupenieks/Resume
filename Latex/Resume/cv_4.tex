...
\name{\Large R. Ben Upenieks\\} % Your name
\address{
\textbf{\textit{Bachelor of Software Engineering}} and \textbf{\textit{Joint Honours in Statistics}}; 3B }
\address
%{248 Golf Course ~$\cdot$~
{(519)  591  9922 ~$\cdot$~   ben.upenieks@uwaterloo.ca ~$\cdot$~ \faGithub \space github.com/bupenieks}% Your address
...
\item Developed and implemented a low level, navigable hierarchical file system on an Arduino microcontroller.%with primitive UNIX-like commands
...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{1ex}} l }
Strong: & \hspace{1ex} Python, C++, Tensorflow, PyTorch, Keras, NumPy, Cython, Java, Git\\%   C++, Qt, Node.js, JavaScript, Java, Android SDK, Git\\
